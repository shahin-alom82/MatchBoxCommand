...
const Banner = () => {
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row rounded-lg mt-10 lg:mt-20">
                <div className=" text-white py-8 px-6 sm:py-10 sm:px-8 md:py-12 md:px-16 lg:py-14 lg:px-20 xl:py-16 xl:px-24">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl">We Care About Quality</h1>
                    <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-4 sm:mt-6 md:mt-8 lg:mt-10 xl:mt-12">MATCHBOX</p>
                    <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-6 sm:mt-8 md:mt-10 lg:mt-12">Your Ultimate Music Bot</p>
                    <div className="flex flex-col sm:flex-row gap-4 mt-6 sm:mt-8 md:mt-10 lg:mt-12 xl:mt-14">
                        <a href="https://discord.com/login"><button className="bg-[#499bae] text-black text-lg sm:text-xl px-6 sm:px-8 h-12 sm:h-14 lg:w-48 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500">Invite to Server</button></a>
                ...
                <div className="flex justify-center mt-6 lg:mt-0">
                    <img className="h-[300px] lg:h-[530px] w-[90%] lg:w-[550px]" src={img} alt="" />
                </div>
            </div>
