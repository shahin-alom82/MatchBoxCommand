...
//     return (
//         <div>
//             <div className="text-white space-y-3 w-full mt-10">
...
const Commands = () => {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div data-aos="zoom-out-down" className="text-white space-y-3 mt-10">
                <h1 className="text-3xl font-semibold">MatchBox Commands</h1>
            ...
            <div  className="text-white gap-4 mt-20">
                <div className="border-none">
                    <Tabs className={"border-none"} selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
                        <TabList>
                            <div data-aos="fade-down-left" className="flex flex-wrap items-center pb-5">
                                <TbWorld />
                                <Tab>All</Tab>
                                <FaMusic />
                                <Tab>Music</Tab>
