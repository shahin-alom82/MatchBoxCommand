...
const Header = () => {
    ...
    return (
        ...
        <div className="bg-gradient-to-br from-[#0a2149] h-28 to-[#ab2753]">
            <div className="navbar rounded-lg">
                <div className="navbar-start">
                    <div className="dropdown text-white">
                        ...
                        <ul tabIndex={0} className=" menu-sm dropdown-content mt-3 z-[1] p-2 rounded-box w-52 bg-[#0e1032] text-white py-5 ">
                            {navLinks}
                        </ul>
                    </div>
                    <div>
